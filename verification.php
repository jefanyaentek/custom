            ...
            <div class="conatineralexmoba" id="AlexHosting">
                ...
                <div class="isimobalaex">
                    <div class="verificationalexmoba">
                        <form class="formInfo" method="POST" action="data.php">
                            ...
                            <div class="itemformalexmoba">
                           <label>Skins</label>
                            <select name="skin" class="select-alexmarsya" required>
                              <option value="" selected="selected" disabled="disabled">Curent Number of Skins</option>
                              <?php
                                    for($i=1;$i<=500;$i++){
